...
def lenet(images, num_classes=10, is_training=False,
  ...
  net = end_points['conv1'] = tf.contrib.slim.conv2d(images, 32, [5, 5], scope='conv1')
  net = end_points['pool1'] = tf.contrib.slim.max_pool2d(net, [2, 2], 2, scope='pool1')
  net = end_points['conv2'] = tf.contrib.slim.conv2d(net, 64, [5, 5], scope='conv2')
  net = end_points['pool2'] = tf.contrib.slim.max_pool2d(net, [2, 2], 2, scope='pool2')
  net = tf.contrib.slim.flatten(net)
  end_points['Flatten'] = net

  net = end_points['fc3'] = tf.contrib.slim.fully_connected(net, 1024, scope='fc3')
  net = tf.contrib.slim.dropout(net, 0.5, is_training=is_training, scope='dropout3')
  logits = tf.contrib.slim.fully_connected(net, 10, activation_fn=None, scope='fc4')
