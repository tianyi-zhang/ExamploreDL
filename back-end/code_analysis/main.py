...
if __name__ == "__main__":
	with open("/Users/mac/Desktop/R/VEDNNAS/backen/code_analysis/test_folder/data.json", "r") as exist_file:
		exist_json = json.load(exist_file)
		num_id = len(list(exist_json.keys())) + 1
		exist_file.close()

	with open('/Users/mac/Desktop/R/VEDNNAS/backen/code_analysis/projects.csv', newline='') as f:
		reader = csv.reader(f)
		data = list(reader)
		paras = data[num_id]
		print(num_id, paras)
	...
	with open("/Users/mac/Desktop/R/VEDNNAS/backen/code_analysis/test_folder/data.json", "w") as outfile:
		paras_id = paras[0]
		paras_Project_Name = paras[1]
		paras_url = paras[2]
		paras_file_name = paras[3]
		paras_type = paras[6]
		dic = '/Users/mac/Desktop/R/VEDNNAS/backen/code_analysis/test_folder/' + paras_Project_Name
